...
update public.settings
   set diamond_packages = coalesce(diamond_packages, '[
    ...
    {"id":"elite","name":"Elite","diamonds":7,"ghs":850,"ngn":85000,
     ...
     "popular":false,"tone":"ice"}
       ...
       gold_packages = coalesce(gold_packages, '[
    ...
    {"id":"gold-pro","name":"Pro","coins":3,"ghs":500,"ngn":50000,
     ...
     "popular":true,"tone":"gold"},
    {"id":"gold-elite","name":"Elite","coins":7,"ghs":850,"ngn":85000,
